...
class BookingTest {
    ...
    void talkback() {
        ...
        LocalDateTime nonPeekend = LocalDateTime.of(2022, 1, 15, 19, 0);
        ...
        assertFalse(Booking.createBooking(talkbackShow, nonPeekend).hasTalkback());

        PremiumExtra premiumExtra = new PremiumExtra(List.of(), 50);
        assertTrue(Booking.createPremiumBook(talkbackShow, nonPeekend, premiumExtra).hasTalkback());
        assertFalse(Booking.createPremiumBook(noTalkbackShow, nonPeekend, premiumExtra).hasTalkback());
    }
